...
MAX_STEPS = 100_000
neural_dyn_gs_kitti_800 = MethodSpecification(
    config=TrainerConfig(
        logging=LoggingConfig(local_writer=LocalWriterConfig(enable=True, max_log_size=0)),
        project_name="4dgf_kitti_benchmark_800",
        method_name="4dgf-kitti-800",
        ...
        optimizers={
            ...
            "camera_opt": {
                ...
                "scheduler": ExponentialDecaySchedulerConfig(lr_final=1e-6, max_steps=MAX_STEPS//4),
            },
            # objects
            "object_poses": {
                "optimizer": AdamOptimizerConfig(lr=1e-5, eps=1e-15, weight_decay=1e-2),
